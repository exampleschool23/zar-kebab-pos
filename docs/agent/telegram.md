...
- The Daily Bazaar PNG omits title/date, groups all numbered items by saved Russian category in catalog order, and shows quantity, bought unit price, and line total. It never truncates; no-data days still render an empty image.
