# Zar Kebab POS Agent Context (Historical Archive)

> Archived on 2026-08-29 when the root agent instructions were split into focused feature guides. Do not read this entire file for routine work. Use it only to research an older regression or migration that is not covered by the focused guides in this directory.
