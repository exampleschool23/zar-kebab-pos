...
const T = {
  uz: {
    ...
    orderSentSub: 'Buyurtmangiz oshxona va kassirga ko‘rinadi.',
  ...
  ru: {
    ...
    orderSentSub: 'Ваш заказ уже виден кухне и кассиру.',
  ...
  en: {
    ...
    orderSentSub: 'Your order is now visible for kitchen and cashier.',
