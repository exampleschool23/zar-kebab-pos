        ...
        {tab === 'items' && (
          <>
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex gap-2 overflow-x-auto scrollbar-none pb-1 flex-1 mr-4">
            ...
            <div className="space-y-2">
              {state.categories.filter(c => c.id !== 'all').map(cat => (
                <div key={cat.id} className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center gap-4 hover:shadow-sm transition-shadow">
                  {cat.image_url ? (
                    <img src={cat.image_url} alt="" className="w-14 h-14 rounded-xl object-cover flex-shrink-0" />
                  ) : (
