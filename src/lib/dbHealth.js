...
const TABLE_CHECKS = [
  ...
  { name: 'employee_kpi_rules', columns: ['id', 'salary_profile_id', 'effective_from', 'rate_bps', 'is_enabled', 'sales_basis', 'order_opener_profile_id', 'last_change_event_id'] },
  { name: 'employee_kpi_rule_change_events', columns: ['id', 'rule_id', 'salary_profile_id', 'employee_name_snapshot', 'change_kind', 'effective_from', 'previous_rate_bps', 'previous_is_enabled', 'new_rate_bps', 'new_is_enabled', 'previous_sales_basis', 'new_sales_basis', 'previous_order_opener_name', 'new_order_opener_name', 'created_by', 'created_by_name', 'created_at'] },
...
const MIGRATION_HINTS = {
  ...
  employee_kpi_rules: 'Run supabase/129_daily_kpi_bonuses.sql, supabase/170_kpi_rule_group_notifications.sql, and supabase/196_configurable_kpi_sales_basis.sql',
  employee_kpi_rule_change_events: 'Run supabase/170_kpi_rule_group_notifications.sql and supabase/196_configurable_kpi_sales_basis.sql',
