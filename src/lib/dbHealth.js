...
const TABLE_CHECKS = [
  ...
  { name: 'menu_items', columns: ['id', 'external_id', 'name_uz', 'name_ru', 'name_en', 'price', 'old_price', 'grams', 'millilitres', 'kcal', 'stock_count', 'option_groups', 'cashier_only', 'public_hidden', 'sort_order', 'deleted_at'] },
  { name: 'menu_categories', columns: ['id', 'name_uz', 'name_ru', 'name_en', 'hidden', 'waiter_hidden', 'sort_order'] },
