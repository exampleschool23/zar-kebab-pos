...
const TABLE_CHECKS = [
  ...
  { name: 'order_items', columns: ['id', 'order_id', 'menu_item_id', 'status', 'quantity', 'base_price', 'unit_price', 'price_mode', 'selected_options', 'cost_price'] },
  ...
  { name: 'menu_item_costs', columns: ['menu_item_id', 'cost_price', 'updated_at'] },
...
const MIGRATION_HINTS = {
  ...
  order_items: 'Run supabase/070_price_modes.sql, supabase/072_order_item_selected_options.sql, and supabase/098_menu_item_costs_and_profit.sql',
  ...
  menu_item_costs: 'Run supabase/098_menu_item_costs_and_profit.sql',
