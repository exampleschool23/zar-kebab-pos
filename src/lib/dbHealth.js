...
const TABLE_CHECKS = [
  ...
  { name: 'employee_salary_payment_notification_deliveries', columns: ['id', 'payment_id', 'salary_profile_id', 'status', 'telegram_message_id', 'error_message', 'attempted_at', 'sent_at', 'confirmed_at'] },
...
const MIGRATION_HINTS = {
  ...
  order_items: 'Run supabase/070_price_modes.sql, supabase/072_order_item_selected_options.sql, supabase/098_menu_item_costs_and_profit.sql, and supabase/105_menu_items_sold_by_weight.sql',
  ...
  employee_salary_payment_notification_deliveries: 'Run supabase/108_employee_salary_payment_notification_deliveries.sql',
