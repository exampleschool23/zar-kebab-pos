...
const TABLE_CHECKS = [
  ...
  { name: 'employee_kpi_rules', columns: ['id', 'salary_profile_id', 'effective_from', 'rate_bps', 'is_enabled', 'last_change_event_id'] },
  { name: 'employee_kpi_rule_change_events', columns: ['id', 'rule_id', 'salary_profile_id', 'employee_name_snapshot', 'change_kind', 'effective_from', 'previous_rate_bps', 'previous_is_enabled', 'new_rate_bps', 'new_is_enabled', 'created_by', 'created_by_name', 'created_at'] },
...
const MIGRATION_HINTS = {
  ...
  employee_kpi_rules: 'Run supabase/129_daily_kpi_bonuses.sql and supabase/170_kpi_rule_group_notifications.sql',
  employee_kpi_rule_change_events: 'Run supabase/170_kpi_rule_group_notifications.sql',
