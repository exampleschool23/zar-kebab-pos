...
const TABLE_CHECKS = [
  ...
  { name: 'menu_items', columns: ['id', 'external_id', 'name_uz', 'name_ru', 'name_en', 'price', 'old_price', 'grams', 'millilitres', 'kcal', 'stock_count', 'option_groups', 'cashier_only', 'sort_order'] },
...
const MIGRATION_HINTS = {
  ...
  employee_salary_profiles: 'Run supabase/054_employee_salary_profiles.sql, supabase/056_employee_salary_profile_end_date.sql, and supabase/060_employee_salary_manual_names.sql',
