...
const TABLE_CHECKS = [
  ...
  { name: 'employee_salary_group_notification_deliveries', columns: ['id', 'event_type', 'event_id', 'salary_profile_id', 'status', 'telegram_chat_id', 'telegram_message_id', 'error_message', 'attempted_at', 'sent_at'] },
...
const MIGRATION_HINTS = {
  ...
  employee_salary_group_notification_deliveries: 'Run supabase/111_salary_group_event_notifications.sql',
