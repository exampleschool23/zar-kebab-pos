...
const TABLE_CHECKS = [
  ...
  { name: 'menu_item_unavailable_notification_deliveries', columns: ['id', 'menu_item_id', 'menu_item_name', 'actor_id', 'actor_name', 'status', 'telegram_chat_id', 'telegram_message_id', 'error_message', 'attempted_at', 'sent_at', 'created_at', 'updated_at'] },
  { name: 'daily_unavailable_menu_notification_deliveries', columns: ['business_date', 'target_key', 'item_count', 'item_ids', 'item_names', 'status', 'telegram_chat_id', 'telegram_message_id', 'error_message', 'attempted_at', 'sent_at', 'created_at', 'updated_at'], access: 'service_only' },
...
const MIGRATION_HINTS = {
  ...
  menu_item_unavailable_notification_deliveries: 'Run supabase/142_menu_unavailable_team_notifications.sql',
  daily_unavailable_menu_notification_deliveries: 'Run supabase/143_daily_unavailable_menu_team_notifications.sql',
