...
const TABLE_CHECKS = [
  ...
  { name: 'business_settings', columns: ['id', 'service_rate_pct', 'restaurant_name', 'monthly_rent_uzs', 'receipt_marketing', 'auto_print', 'auto_print_kitchen_check'] },
  ...
  { name: 'menu_categories', columns: ['id', 'name_uz', 'name_ru', 'name_en', 'hidden', 'waiter_hidden', 'visible_from_time', 'visible_until_time', 'sort_order', 'deleted_at'] },
...
const MIGRATION_HINTS = {
  ...
  business_settings: 'Run supabase/011_business_settings.sql, supabase/073_business_settings_monthly_rent.sql, supabase/074_receipt_marketing_setting.sql, and supabase/081_auto_print_kitchen_check_setting.sql',
  ...
  menu_categories: 'Run supabase/053_hidden_menu_categories.sql, supabase/080_menu_category_waiter_hidden.sql, supabase/082_menu_visibility_windows.sql, and supabase/115_archive_menu_catalog_deletions.sql',
  ...
  employee_salary_group_notification_deliveries: 'Run supabase/111_salary_group_event_notifications.sql, supabase/112_salary_event_employee_notifications.sql, supabase/113_salary_notification_attempt_tracking.sql, and supabase/116_salary_rate_change_telegram_notifications.sql',
