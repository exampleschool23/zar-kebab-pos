...
const TABLE_CHECKS = [
  ...
  { name: 'menu_item_tech_card_components', columns: ['id', 'menu_item_id', 'component_menu_item_id', 'quantity', 'sort_order', 'created_at', 'updated_at'] },
...
const MIGRATION_HINTS = {
  ...
  orders: 'Run supabase/075_order_actor_tracking.sql, supabase/106_atomic_paid_order_stock_deduction.sql, supabase/150_tech_card_component_stock_deduction.sql, and supabase/151_tech_card_component_piece_quantities.sql',
  ...
  menu_item_tech_card_components: 'Run supabase/149_tech_card_menu_item_components.sql',
  ...
  save_menu_item_tech_card: 'Run supabase/139_menu_item_tech_cards.sql and supabase/149_tech_card_menu_item_components.sql',
