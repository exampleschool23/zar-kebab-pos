...
const TABLE_CHECKS = [
  ...
  { name: 'expenses', columns: ['id', 'expense_date', 'category', 'payment_method', 'amount', 'vendor', 'description', 'created_by_name'] },
  { name: 'menu_items', columns: ['id', 'external_id', 'name_uz', 'name_ru', 'name_en', 'price', 'old_price', 'grams', 'millilitres', 'kcal', 'stock_count', 'sort_order'] },
...
const MIGRATION_HINTS = {
  ...
  loyalty_transactions: 'Run supabase/022_loyalty_cashback_wallet.sql and supabase/051_remove_loyalty_cards_preserve_history.sql',
  expenses: 'Run supabase/048_expenses.sql',
  ...
  menu_items: 'Run supabase/033_menu_item_grams.sql, supabase/034_menu_item_millilitres.sql, supabase/036_menu_item_old_price.sql, supabase/037_menu_item_external_id.sql, supabase/038_generate_immutable_menu_item_external_ids.sql, and supabase/050_menu_item_stock_count.sql',
