...
const TABLE_CHECKS = [
  ...
  { name: 'menu_items', columns: ['id', 'external_id', 'name_uz', 'name_ru', 'name_en', 'price', 'old_price', 'grams', 'millilitres', 'kcal', 'stock_count', 'option_groups', 'cashier_only', 'sort_order', 'deleted_at'] },
