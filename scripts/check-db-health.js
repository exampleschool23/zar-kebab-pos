...
const checks = await Promise.all([
  ...
  checkTable('employee_salary_group_notification_deliveries', 'id, event_type, event_id, salary_profile_id, status, telegram_chat_id, telegram_message_id, error_message, attempted_at, sent_at', false),
