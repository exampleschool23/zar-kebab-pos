...
const checks = await Promise.all([
  ...
  checkTable('daily_unavailable_menu_notification_deliveries', 'business_date, target_key, item_count, item_ids, item_names, status, telegram_chat_id, telegram_message_id, error_message, attempted_at, sent_at, created_at, updated_at'),
