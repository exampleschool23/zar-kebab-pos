...
const checks = await Promise.all([
  ...
  checkTable('employee_kpi_rules', 'id, salary_profile_id, effective_from, rate_bps, is_enabled, last_change_event_id', false),
  checkTable('employee_kpi_rule_change_events', 'id, rule_id, salary_profile_id, employee_name_snapshot, change_kind, effective_from, previous_rate_bps, previous_is_enabled, new_rate_bps, new_is_enabled, created_by, created_by_name, created_at', false),
