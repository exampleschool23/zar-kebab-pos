...
create table if not exists public.loyalty_cards (
  ...
  phone_number   text,
  cashback_type  text not null default 'bronze' check (cashback_type in ('bronze', 'silver', 'gold', 'premium', 'black', 'special')),
...
create table if not exists public.loyalty_transactions (
  ...
  card_type_at_transaction text check (card_type_at_transaction is null or card_type_at_transaction in ('bronze', 'silver', 'gold', 'premium', 'black', 'special')),
