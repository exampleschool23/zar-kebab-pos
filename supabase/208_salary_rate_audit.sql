-- Preserve salary rate edits and deletions without inventing historical audit events.
begin;
...
begin
  v_entity_type := case tg_table_name
    ...
    when 'employee_salary_rates' then 'salary_rate'
    else null
  end;
...
drop trigger if exists audit_salary_rate_records on public.employee_salary_rates;
create trigger audit_salary_rate_records
after insert or update or delete on public.employee_salary_rates
