...
test('Auto-print bill saves immediately and prints after a successful move to cashier', () => {
  ...
  assert.match(cashierBill, /async function handlePrintBill\(\)[\s\S]*refreshCurrentBill\(\)[\s\S]*getFreshCashierPaymentQuote\([\s\S]*navigate\(getBillReceiptPath\(\{ tableId, orderId \}\)\)/)
