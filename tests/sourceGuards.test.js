...
test('expenses page is feature-gated, persisted, and included in owner reports net income', () => {
  ...
  assert.match(expenses, /label=\{l\.investorIncome\}[\s\S]*value=\{loading \? '—' : formatCurrency\(investorSupportTotal\)\}/)
  ...
  assert.match(expenses, /mb-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4/)
  ...
  assert.match(salaries, /\{formatCurrency\(monthlyPayrollTotal\)\}/)
