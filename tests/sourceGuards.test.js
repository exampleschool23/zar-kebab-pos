...
test('expenses page is feature-gated, persisted, and included in owner reports net income', () => {
  ...
  assert.match(monthlyEstimate, /monthlyUtilitiesUzs: state\.settings\?\.monthlyUtilitiesUzs \|\| 0/)
  assert.match(monthlyEstimate, /const rentDueUzs = Math\.max\(0, monthlyEstimate\.monthlyRentUzs - recordedRentTotal\)/)
  assert.match(monthlyEstimate, /const utilitiesDueUzs = Math\.max\(0, monthlyEstimate\.monthlyUtilitiesUzs - recordedUtilitiesTotal\)/)
  assert.match(monthlyEstimate, /const remainingCommitmentsUzs = monthlyEstimate\.employeeRemainingTotal \+ rentDueUzs \+ utilitiesDueUzs/)
  assert.match(monthlyEstimate, /const projectedLeftUzs = netLeft - remainingCommitmentsUzs/)
  assert.match(monthlyEstimate, /const expenseBreakdownCards = \[/)
  assert.match(monthlyEstimate, /employeeFineToDate/)
  assert.match(monthlyEstimate, /employeeArrearsRemaining/)
  ...
  assert.match(monthlyEstimate, /formatCurrency\(utilitiesDueUzs\)/)
