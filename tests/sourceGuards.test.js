...
test('menu costs stay private, snapshot onto sold items, and drive profit outputs', () => {
  ...
  assert.match(accountingPage, /value=\{formatCurrencyWithPercentage\(netProfit, profitMarginPct, lang\)\}/)
...
test('expenses page is feature-gated, persisted, and included in owner reports net income', () => {
  ...
  assert.match(expenses, /expensePromise\.then\(expenseResult => \{[\s\S]*setExpenses\([\s\S]*setLoading\(false\)/)
