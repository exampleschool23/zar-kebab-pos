...
test('expenses page is feature-gated, persisted, and included in owner reports net income', () => {
  ...
  assert.match(monthlyEstimate, /const rentDueUsd = recordedRentTotal > 0 \? 0 : rentUsd/)
  assert.match(monthlyEstimate, /tone: monthlyEstimate\.employeeRemainingThisMonth > 0 \? 'red' : 'green'/)
  assert.match(monthlyEstimate, /tone: rentDueUsd > 0 \? 'red' : 'green'/)
  assert.match(monthlyEstimate, /formatUsd\(rentDueUsd\)/)
