...
test('AdminSettings persists the average daily employee meal and forecasts present employee-days', () => {
  ...
  assert.match(reports, /buildEmployeeMealExpenseRows\(/)
  assert.match(reports, /expenseSummary\.byCategory\.employee_meals/)
  assert.match(accounting, /buildEmployeeMealExpenseRows\(/)
  assert.match(accounting, /formatCurrency\(employeeMealExpensesTotal\)/)
  assert.match(accountingHistory, /buildEmployeeMealExpenseRows\(/)
...
test('all accounting summary includes paid cafe income', () => {
  ...
  assert.match(history, /buildEmployeeMealExpenseRows/)
  assert.match(history, /state\.settings\?\.averageDailyEmployeeMealUzs/)
  ...
  assert.match(history, /\}, \[dateFrom, dateTo, state\.settings\?\.averageDailyEmployeeMealUzs\]\)/)
