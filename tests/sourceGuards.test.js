...
test('cashier-only menu items are hidden from customer menus but available to cashier quick items', () => {
  ...
  assert.match(waiterOrder, /isWaiterMenuItem\(item\)/)
...
test('public-hidden menu items stay available to waiter table ordering', () => {
  ...
  assert.match(publicMenu, /isCustomerMenuItem\(item\)/)
  assert.match(telegram, /isCustomerMenuItem\(item\)/)
...
test('hidden menu categories are hidden from customer-facing menus only', () => {
  ...
  assert.match(waiterOrder, /filter\(isWaiterMenuCategory\)/)
  ...
  assert.match(health, /menu_categories', 'id, name_uz, name_ru, name_en, hidden, waiter_hidden, sort_order'/)
})
