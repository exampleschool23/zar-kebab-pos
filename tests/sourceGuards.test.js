...
test('all accounting summary includes paid cafe income', () => {
  ...
  assert.match(history, /row\.is_salary_payment[\s\S]*border-l-red-500 bg-red-50\/30[\s\S]*bg-red-100 text-red-700/)
  assert.match(history, /row\.is_salary_bonus[\s\S]*border-l-blue-500 bg-blue-50\/30/)
})
