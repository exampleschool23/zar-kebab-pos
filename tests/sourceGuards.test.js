...
test('menu costs stay private, snapshot onto sold items, and drive profit outputs', () => {
  ...
  assert.match(accounting, /netProfit: getOrdersNetProfit\(paidOrders, menuItemMap\)/)
  assert.match(accountingPage, /label=\{l\.netProfit\} value=\{formatCurrency\(netProfit\)\}/)
