...
test('Daily Bazaar Telegram message lists product quantity unit price and date total', () => {
  const message = buildDailyBazaarGroupMessage([{
    ...
    bazaar_purchase_items: [
      { product_name: 'Tomatoes <red>', quantity: 5, unit: 'kg', line_total: 60_000, normal_unit_price: 11_000, normal_line_total: 55_000, price_difference: 5_000, sort_order: 0 },
  ...
  assert.match(message, /Normal-price total: 55\D000 UZS · Difference: <b>\+5\D000 UZS<\/b>/)
  ...
  assert.match(message, /Difference: <b>\+5\D000 UZS<\/b>/)
})
